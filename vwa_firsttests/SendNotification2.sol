...
contract SendNotifications2 {
    ...
    function logging() public payable{
        counter = counter + 1;
    }

    
    function sendNotification(string memory message) payable external {
            ...
            bytes(
                string(
                    ...
                    abi.encodePacked(
                        ...
                        "+", // segregator
                        "Balance Update", // this is notificaiton title
                        "+", // segregator
